...
<Table>
  <tr>
   ...
   <tr>   
    ...
    <td>3) Create a site and name it CrisisCommunications. You can pick any name but make sure it is one word.
           There is another place to put the displayed title of the App. 
           For now press OK.</td>
  ...
  <tr>
    <td>7) A windows will appear to enter a name for the list.</td>
  ...
  <tr>
     <td> 9) When the new list is created, got to the upper right and click on the gear.   </td>
     <td>   <a href="images/S6_CustomList.png"><img src="images/S6_CustomList.png" width="250"></a></td>
  </tr>
  ...
  <tr>  
   ...
   <tr>
    <td> 11) Enter the name of "AppSettings". Then press create.  </td>
    <td><a href="images/s8_Appset.png"><img src="images/s8_Appset.png" width="250"></a></td>
  </tr>   
