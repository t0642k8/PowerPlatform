...
<Table>
  ...
  <tr>
    <td>7) Click on the elipses menu near the screen componet on the left side of the screen and select AP7_rename
  ...
  <tr>  
   ...
   <tr>
    <td> 8) On the right panel on the screen  we will select the background image.   </td>
